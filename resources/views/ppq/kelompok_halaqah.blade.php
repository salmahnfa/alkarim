							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Kelompok Halaqah</h4>
											...
											<tbody>
												@foreach ($guru_qurans as $guru_quran)
													<tr>
														...
														<td>{{ $guru_quran->user->nama }}</td>
														<td>
															@foreach ($guru_quran->siswa as $siswa)
																{{ $siswa->nama }}<br><!--{{ !$loop->last ? ', ' : '' }}-->
															@endforeach
														</td>
														<td>
															<div class="form-button-action">
																<a href="/admin_unit/{{ $guru_quran->id }}/edit" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
